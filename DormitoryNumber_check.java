...
public class DormitoryNumber_check extends JFrame {
	...
	public DormitoryNumber_check() {
		...
		textField_13.setFont(new Font("±º∏≤", Font.PLAIN, 16));
		...
		textField_21.setFont(new Font("±º∏≤", Font.PLAIN, 16));
		...
		textField_22.setFont(new Font("±º∏≤", Font.PLAIN, 16));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "»£Ω« ¡∂»∏ ¡ﬂ¿‘¥œ¥Ÿ ...");
			}
		});
