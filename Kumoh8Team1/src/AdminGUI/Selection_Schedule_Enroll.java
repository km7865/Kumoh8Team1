...
public class Selection_Schedule_Enroll extends JFrame {
   ...
   public Selection_Schedule_Enroll(Protocol p_t, ObjectOutputStream writer_t, ObjectInputStream reader_t, Socket sk) {
      socket = sk;
      p = p_t;
      writer = writer_t;
      reader = reader_t;
      ...
      btnNewButton.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            ...
            String code = null;
            if (textField_5.getText() != null) code = textField_5.getText();
            
            if (start_date.compareTo(end_date) != 1 && start_date.length() == 8 && end_date.length() == 8) // true
            {
               ...
               SelectionSchedule selectionSchedule = new SelectionSchedule(0, 0, null, start_date, end_date,
                     content);
               if (code != null) selectionSchedule.setProgram_code(code);
      ...
      textField_5.setBounds(180, 15, 40, 40);
